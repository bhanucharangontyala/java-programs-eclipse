...
public class HomeLoan extends Loan {
	...
	static void setAssetsDetails() {
		System.out.println("Enter your assets and property value");
		assets = sc.nextDouble();
	}

	static void getAssetsDetails() {
		System.out.println(" Your assets and property value is : " + assets);
	}

	public static void main(String[] args) {
		Loan l1 = new Loan();
		System.out.println("Welcome To Mee Illu Bangaram Kanu Home Loan Banking");
		...
		setSalDetails();
		setAssetsDetails();
		if (l1.getSalary() >= 40000 && l1.getAge() >= 25 && l1.getCibilScore() >= 700 
				&&assets >=1000000 && ((m1+m2+m3)/3 >=40000)) {
			...
			System.out.println("The Tenure is :" + tenure + " Months");
		} else {
